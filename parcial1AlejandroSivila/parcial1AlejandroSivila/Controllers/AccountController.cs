...
using parcial1AlejandroSivila.Models;
using parcial1AlejandroSivila.Providers;
using parcial1AlejandroSivila.Results;

namespace parcial1AlejandroSivila.Controllers
{
    [Authorize]
